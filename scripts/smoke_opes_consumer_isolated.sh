...
# Nombre historico del modo; el script REST recorre hasta el ultimo tipo de
# ORQUESTA_OPES_BRIDGE_JOB_TYPE_SEQUENCE, hoy generate_audio_asset.
...
export ORQUESTA_OPES_BRIDGE_MAX_TICKS="${ORQUESTA_OPES_BRIDGE_MAX_TICKS:-10}"
