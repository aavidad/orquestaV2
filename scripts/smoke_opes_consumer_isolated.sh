...
# Recorre hasta el ultimo tipo de ORQUESTA_OPES_BRIDGE_JOB_TYPE_SEQUENCE.
export ORQUESTA_OPES_DERIVATIVES_SMOKE_MODE=run-until-finalize
export ORQUESTA_OPES_DERIVATIVES_TICK_SLEEP_SECONDS="${ORQUESTA_OPES_DERIVATIVES_TICK_SLEEP_SECONDS:-0}"
export ORQUESTA_OPES_BRIDGE_MAX_TICKS="${ORQUESTA_OPES_BRIDGE_MAX_TICKS:-40}"
