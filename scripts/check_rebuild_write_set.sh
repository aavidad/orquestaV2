...
for path in "${changed[@]}"; do
  if [[ "$base_ref" == "8063d8ce3ed75dd5ec92108ef6e7e73ee8e11cb8" ]]; then
    ...
    case "$path" in
      ...
      internal/commands/definitions_generated.go|internal/commands/dispatcher.go|internal/commands/dispatcher_test.go|internal/commands/handlers_goal.go|internal/commands/output.go|internal/commands/registry.json|internal/commands/v22_public_projection_test.go|\
