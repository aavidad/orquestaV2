...
for path in "${changed[@]}"; do
  if [[ "$base_ref" == "8063d8ce3ed75dd5ec92108ef6e7e73ee8e11cb8" ]]; then
    ...
    case "$path" in
      ...
      cmd/orquesta/main.go|cmd/orquesta/main_test.go|\
      internal/adapters/agent/codex/adapter.go|internal/adapters/agent/codex/adapter_integration_test.go|internal/adapters/agent/codex/adapter_shutdown_linux_test.go|internal/adapters/agent/codex/adapter_shutdown_test.go|internal/adapters/agent/codex/cgroup_linux.go|internal/adapters/agent/codex/cgroup_other.go|internal/adapters/agent/codex/completion_proof.go|internal/adapters/agent/codex/config.go|internal/adapters/agent/codex/control.go|internal/adapters/agent/codex/control_journal_recovery.go|internal/adapters/agent/codex/control_linux_test.go|internal/adapters/agent/codex/control_persistence.go|internal/adapters/agent/codex/control_stop.go|internal/adapters/agent/codex/credential.go|internal/adapters/agent/codex/credential_integration_test.go|internal/adapters/agent/codex/persistence.go|internal/adapters/agent/codex/process.go|internal/adapters/agent/codex/process_control.go|internal/adapters/agent/codex/process_control_linux.go|internal/adapters/agent/codex/process_control_other.go|internal/adapters/agent/codex/process_group_unix.go|internal/adapters/agent/codex/prompt.go|internal/adapters/agent/codex/prompt_test.go|internal/adapters/agent/codex/recovery_test.go|internal/adapters/agent/codex/session.go|internal/adapters/agent/codex/session_test.go|internal/adapters/agent/codex/supervisor_linux.go|internal/adapters/agent/codex/supervisor_linux_test.go|internal/adapters/agent/codex/supervisor_other.go|internal/adapters/agent/codex/supervisor_other_test.go|internal/adapters/agent/codex/supervisor_protocol.go|internal/adapters/agent/codex/upgrade_v3_test.go|\
      ...
      internal/adapters/state/sqlite/app_specs_test.go|internal/adapters/state/sqlite/claim.go|internal/adapters/state/sqlite/command_audit_test.go|internal/adapters/state/sqlite/controls.go|internal/adapters/state/sqlite/controls_validation.go|internal/adapters/state/sqlite/council_mutation.go|internal/adapters/state/sqlite/council_validate.go|internal/adapters/state/sqlite/director.go|internal/adapters/state/sqlite/director_test.go|internal/adapters/state/sqlite/execution_session.go|internal/adapters/state/sqlite/execution_session_test.go|internal/adapters/state/sqlite/identity_access.go|internal/adapters/state/sqlite/identity_runtime_test.go|internal/adapters/state/sqlite/mailbox.go|internal/adapters/state/sqlite/mailbox_delivery.go|internal/adapters/state/sqlite/mailbox_read.go|internal/adapters/state/sqlite/mailbox_record_validation.go|internal/adapters/state/sqlite/mailbox_resolution.go|internal/adapters/state/sqlite/mailbox_schema_test.go|internal/adapters/state/sqlite/mailbox_test.go|internal/adapters/state/sqlite/migrations/016_post_artifact_mailbox.sql|internal/adapters/state/sqlite/mutations.go|internal/adapters/state/sqlite/read.go|internal/adapters/state/sqlite/recovery_v09_test.go|internal/adapters/state/sqlite/recovery_v10_test.go|internal/adapters/state/sqlite/recovery_validation.go|internal/adapters/state/sqlite/recovery_validation_v10.go|internal/adapters/state/sqlite/recovery_validation_v14_controls.go|internal/adapters/state/sqlite/recovery_validation_v14_effects.go|internal/adapters/state/sqlite/recovery_validation_v21.go|internal/adapters/state/sqlite/recovery_validation_v21_test.go|internal/adapters/state/sqlite/recovery_validation_versions.go|internal/adapters/state/sqlite/repository_test.go|internal/adapters/state/sqlite/v10_migration_test.go|internal/adapters/state/sqlite/v16_workspace_git_test.go|internal/adapters/state/sqlite/v18_migration_test.go|internal/adapters/state/sqlite/v19_council_test.go|internal/adapters/state/sqlite/v19_migration_test.go|internal/adapters/state/sqlite/validate.go|internal/adapters/state/sqlite/workspace_git_read.go|internal/adapters/state/sqlite/write.go|\
      internal/adapters/workspace/gitlocal/adapter.go|internal/adapters/workspace/gitlocal/adapter_test.go|internal/adapters/workspace/gitlocal/workspace.go|\
      internal/application/access.go|internal/application/control_processing.go|internal/application/control_stop_settlement.go|internal/application/control_validation.go|internal/application/council_cleanup.go|internal/application/council_processing.go|internal/application/council_retry.go|internal/application/council_state.go|internal/application/effect_admission.go|internal/application/effect_target_test.go|internal/application/effect_unknown_applied_test.go|internal/application/execution_session.go|internal/application/execution_session_test.go|internal/application/mailbox.go|internal/application/mailbox_admission.go|internal/application/mailbox_delivery.go|internal/application/mailbox_state.go|internal/application/mailbox_test.go|internal/application/mailbox_validation.go|internal/application/orchestrator.go|internal/application/post_artifact_delivery.go|internal/application/post_artifact_delivery_test.go|internal/application/processing.go|internal/application/review_processing.go|internal/application/state.go|internal/application/terminal_security_test.go|internal/application/test_support_test.go|internal/application/validation.go|\
      internal/bootstrap/budgets_effects_e2e_test.go|internal/bootstrap/codex_cgroup_fixture_linux_test.go|internal/bootstrap/codex_cgroup_fixture_other_test.go|internal/bootstrap/codex_prompt.go|internal/bootstrap/codex_prompt_test.go|internal/bootstrap/controls_e2e_test.go|internal/bootstrap/execution_authority_test.go|internal/bootstrap/execution_session.go|internal/bootstrap/execution_session_test.go|internal/bootstrap/private_invocation.go|internal/bootstrap/runtime.go|internal/bootstrap/runtime_scope.go|internal/bootstrap/runtime_scope_test.go|internal/bootstrap/supervisor_test.go|internal/bootstrap/test_support_test.go|internal/bootstrap/workspace_git_v16_crash_test.go|internal/bootstrap/workspace_git_v16_e2e_test.go|internal/bootstrap/workspace_git_v16_fixture_test.go|internal/bootstrap/workspace_git_v16_harness_test.go|\
      internal/commands/cmd/commandgen/main.go|internal/commands/cmd/commandgen/main_test.go|internal/commands/definitions_generated.go|internal/commands/dispatcher.go|internal/commands/dispatcher_test.go|internal/commands/handlers_goal.go|internal/commands/handlers_mailbox.go|internal/commands/model.go|internal/commands/output.go|internal/commands/registry.json|internal/commands/registry_contract.go|internal/commands/v22_public_projection_test.go|\
      internal/config/cmd/configgen/main.go|internal/config/config_test.go|internal/config/keys_generated.go|internal/config/loader.go|internal/config/registry.go|internal/config/v07_registry_test.go|internal/config/v17_test_attestor_test.go|internal/config/value.go|\
      internal/i18n/catalog_test.go|internal/i18n/catalogs/en.json|internal/i18n/catalogs/es.json|internal/i18n/manifest.go|internal/i18n/manifest.json|internal/identity/contracts_test.go|internal/identity/membership.go|internal/identity/policy.go|internal/interfaces/mcp/v20_commands.go|internal/interfaces/mcp/v20_commands_test.go|internal/interfaces/mcp/v22_public_projection_test.go|internal/ports/agent.go|internal/ports/agent_contract_test.go|internal/ports/execution_session.go|\
