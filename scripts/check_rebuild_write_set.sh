...
for path in "${changed[@]}"; do
  if [[ "$base_ref" == "8063d8ce3ed75dd5ec92108ef6e7e73ee8e11cb8" ]]; then
    ...
    case "$path" in
      ...
      internal/bootstrap/codex_prompt.go|internal/bootstrap/codex_prompt_test.go|internal/bootstrap/execution_authority_test.go|internal/bootstrap/execution_session.go|internal/bootstrap/execution_session_test.go|internal/bootstrap/runtime.go|internal/bootstrap/supervisor_test.go|\
