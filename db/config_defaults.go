...
func defaultConfigEntries() []configDefaultEntry {
	return []configDefaultEntry{
		...
		{Clave: "autonomia_session_step_timeout_seconds", Valor: "1"},
		{Clave: "autonomia_degraded_batch_timeout_seconds", Valor: "1"},
		{Clave: "autonomia_batch_budget_seconds", Valor: "1"},
		...
		{Clave: "runtime_transcript_batch_budget_ms", Valor: "300"},
		{Clave: "runtime_transcript_ingest_max_bytes", Valor: "16384"},
		...
		{Clave: "server_autobootstrap_start_delay_seconds", Valor: "8"},
