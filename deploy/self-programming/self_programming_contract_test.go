...
func TestSelfProgrammingEnvV0KeepsProductionAndFallbacksOff(t *testing.T) {
	...
	want := map[string]string{
		...
		"ORQUESTA_CODEX_CONTAINER_SANDBOX_BOUNDARY_CONFIRMED": "1",
...
func TestSelfProgrammingImageV0IncludesPinnedIntegrationRuntime(t *testing.T) {
	...
	for _, snippet := range []string{
		...
		"ca-certificates bash curl gcc git iptables jq libc6-dev openssh-client poppler-utils procps python3 tmux",
