...
// RunFirecrackerAttestorE2E composes and runs the physical attestor supervisor.
func RunFirecrackerAttestorE2E(arguments []string, stdout, stderr io.Writer) int {
	if len(arguments) == 1 {
