...
func Render(config Config, request RenderRequest) (RenderedPlan, error) {
	...
	receipt := PlanReceipt{
		...
		LaunchCredentialRef:        request.Policy.LaunchCredential.Ref.String(),
		LaunchCredentialOwnerRef:   request.Policy.LaunchCredential.OwnerRef.String(),
		LaunchCredentialScopeRef:   request.Policy.LaunchCredential.ScopeRef.String(),
		LaunchCredentialPurposeRef: request.Policy.LaunchCredential.PurposeRef.String(),
		LaunchCredentialVersion:    uint64(request.Policy.LaunchCredential.Version),
...
func planProjection(
	...
	document := planDocument{
		...
		LaunchCredentialOwnerRef:   policy.LaunchCredential.OwnerRef.String(),
		LaunchCredentialScopeRef:   policy.LaunchCredential.ScopeRef.String(),
		LaunchCredentialPurposeRef: policy.LaunchCredential.PurposeRef.String(),
