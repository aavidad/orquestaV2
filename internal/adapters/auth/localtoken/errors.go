...
const (
	...
	CodeManifestInvalid      ErrorCode = "localtoken.manifest_invalid"
	CodeManifestPermissions  ErrorCode = "localtoken.manifest_permissions"
	CodeManifestTooLarge     ErrorCode = "localtoken.manifest_too_large"
