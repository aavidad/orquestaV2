...
func TestRepositoryOpenAppliesPrivateModesMigrationsAndPragmas(t *testing.T) {
	...
	wantTables := []string{
		"action_consumption_receipts", "agent_capacity_observations", "agent_capacity_reservations", "agent_capacity_transitions", "agent_environment_lifecycles", "agent_environment_receipts", "agent_placement_bindings", "agent_provider_requests", "agent_provider_stop_requests", "agent_quota_observations", "app_specs", "artifact_occurrences", "artifacts", "attestation_test_outcomes", "attestations", "authorization_receipts",
