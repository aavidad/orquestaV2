...
func TestRepositoryOpenAppliesPrivateModesMigrationsAndPragmas(t *testing.T) {
	...
	if foreignKeys != 1 || busyTimeout != int(testBusyTimeout.Milliseconds()) || userVersion != recoverySchemaLatest {
	...
	wantTables := []string{
		"action_consumption_receipts", "agent_capacity_observations", "agent_capacity_reservations", "agent_capacity_transitions", "agent_environment_lifecycles", "agent_environment_receipts", "agent_launch_expired_continuation_authorities", "agent_launch_expired_continuation_subjects", "agent_launch_reconciliation_attempts", "agent_launch_reconciliation_authorities", "agent_launch_reconciliation_jobs", "agent_launch_reconciliation_receipts", "agent_placement_bindings", "agent_quota_observations", "app_specs", "artifact_occurrences", "artifacts", "attestation_test_outcomes", "attestations", "authorization_receipts",
		...
		"membership_audit_receipts", "merge_observations", "microvm_host_launch_authorities", "microvm_host_launch_runtime_digest_epoch", "microvm_host_launch_runtime_digest_legacy_exemptions", "microvm_host_launch_runtime_digests", "outbox", "principals", "project_memberships", "projects", "repositories", "review_records", "schema_migrations",
