...
func TestRepositoryOpenAppliesPrivateModesMigrationsAndPragmas(t *testing.T) {
	...
	wantTables := []string{
		"action_consumption_receipts", "agent_capacity_observations", "agent_capacity_reservations", "agent_capacity_transitions", "agent_placement_bindings", "agent_quota_observations", "app_specs", "artifact_occurrences", "artifacts", "attestation_test_outcomes", "attestations", "authorization_receipts",
