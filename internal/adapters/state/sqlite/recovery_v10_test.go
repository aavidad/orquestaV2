...
WHERE type = 'table' AND name IN ('principals', 'project_memberships', 'authorization_receipts')`).Scan(&v10Tables); err != nil {
	...
	assertRecoverySchemaVersion(t, migrated.db, recoverySchemaV38EnvironmentGate)
	var bound int
...
func TestV10RecoveryRestoresExactV10IdentitySnapshot(t *testing.T) {
	...
	if receipt.SchemaRef != migrationSchemaRef(migrations[:recoverySchemaV38EnvironmentGate]) {
	...
	defer raw.Close()
	assertRecoverySchemaVersion(t, raw, recoverySchemaV38EnvironmentGate)
...
func TestRecoveryCanonicalInventoryAndSchemaRefAreVersioned(t *testing.T) {
	...
	if v09 == v10 || v09 == v12 || v09 == v13 || v09 == v14 ||
		...
		!strings.HasPrefix(v14, "sha256:") {
		t.Fatalf("canonical inventories not versioned: V09=%s V10=%s V12=%s V13=%s V14=%s", v09, v10, v12, v13, v14)
	}
	migrations, _ := loadMigrations()
	...
	v14Ref := migrationSchemaRef(migrations[:recoverySchemaV14])
	if v09Ref == v10Ref || v09Ref == v12Ref || v09Ref == v13Ref || v09Ref == v14Ref ||
		v10Ref == v12Ref || v10Ref == v13Ref || v10Ref == v14Ref ||
		v12Ref == v13Ref || v12Ref == v14Ref || v13Ref == v14Ref ||
		...
		!strings.HasPrefix(v14Ref, schemaRefPrefix) {
		t.Fatalf("schema refs not versioned: V09=%s V10=%s V12=%s V13=%s V14=%s", v09Ref, v10Ref, v12Ref, v13Ref, v14Ref)
	}
}
