...
| T-PER-301 | BLOQUEADA-POR-WRITE-SET / BUG-149 | — | 2026-07-03 | el bloque remoto sucio que pisa `cmd/orquesta-server/codex_goal_app_server*` fue traido como patch y probado en `/tmp/orquesta-remote-dirty-review`; no es integrable entero porque falla `orquesta-app-codex-stack`. Ver `BUG-ORQ-20260703-149`. Siguiente paso: extraer por piezas o reimplementar T-PER-301 sobre rama limpia |
| T-PER-302 | bloqueada (dep: 301) | — | — | — |
| T-PER-401 | BLOQUEADA-POR-WRITE-SET / BUG-149 | — | 2026-07-03 | el mismo bloque remoto toca shutdown/runtime/smoke y falla pruebas; no usarlo como base directa. Ver `BUG-ORQ-20260703-149`. Siguiente paso: implementar contrato de shutdown en dos fases sobre rama limpia o extraer solo tests utiles |
