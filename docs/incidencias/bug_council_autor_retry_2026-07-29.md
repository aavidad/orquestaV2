...
Estado: corregida y ejercitada localmente; pendiente de revisión y acreditación
de release.
...
El gate raíz completo no puede acreditar este write-set aislado: el árbol ya
presenta guards de arquitectura y receipts ajenos en rojo, y añadir un fichero
a `docs/incidencias` exige actualizar el censo y los ledgers de trazabilidad.
Esos ficheros no pertenecen al write-set autorizado. La incidencia permanece
por ello pendiente de revisión y acreditación aunque los paquetes afectados,
el restart y la carrera focal estén verdes.
