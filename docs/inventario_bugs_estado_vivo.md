...
| BUG-ORQ-20260710-208S | una ola Codex observable puede acumular diagnostico interno sin ACK, mensaje final ni cambio de write-set hasta que el operador la corta | presupuesto de progreso/diagnostico por composicion con parada cooperativa, recibo durable y rework; evidencia en la [incidencia 208S](incidencias/incidencia_orquesta_ola_codex_sin_progreso_diagnostico_excesivo_2026-07-10.md) |
