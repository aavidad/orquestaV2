...
| F5/identidad runtime | candidata rebasada `wip/f5-degraded-r8-20260710` (`4613dabf4`) valida ctl/worktree, degrada identidad y limpia backend por identidad; focales verdes, no integrada | revision externa, integrar y solo despues ejecutar drain/deploy gobernados |
