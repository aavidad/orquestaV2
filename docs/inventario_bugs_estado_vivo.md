...
| S13/F4 artefactos versionados | conteo vivo: 61 con nombre de checkpoint/resultado; 68 al incluir cuatro fixtures eval y tres artefactos auxiliares de la familia. El adaptador Codex app-server ya escribe y lee primero recibos por goal bajo `.orquesta-runtime/goal-receipts/`; el guard Git conserva el rechazo de nuevos no clasificados. Quedan Claude/Gemini, la proyeccion comun de procedencia y la migracion de 58 movibles. Evidencia en la [incidencia S13](incidencias/incidencia_orquesta_s13_destino_recibos_runtime_2026-07-10.md). | extender destino/observador a proveedores restantes; despues migrar los 58 movibles con commits gobernados |
