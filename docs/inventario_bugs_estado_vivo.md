...
| BUG-ORQ-20260711-208AG | avance: refs obligatorias y `acceptance_checks` tipados ya se congelan y atestan de forma independiente; V0/V1/MCP los conservan y el fallback idle no acepta `complete` autodeclarado. Residual: callers legacy con solo `acceptance_criteria` textual no declaran que criterio es verificable ni su comando | migrar Director humano/backlog/callers productivos a checks tipados o clasificacion cualitativa explicita; repetir U1000 con el analizador como check independiente y cerrar solo si detecta el fixture residual. Evidencia en la [incidencia 208AG](incidencias/incidencia_orquesta_cleanup_symbols_self_declared_2026-07-11.md), relacionada con [208H](../pruebas_revisor_208h_2026-07-10.md) y [208AF](incidencias/incidencia_orquesta_goal_observer_high_consumption_terminal_reconcile_2026-07-11.md) |
