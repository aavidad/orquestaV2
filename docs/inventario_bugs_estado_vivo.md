...
Actualizado: 2026-07-11 (208AG y 208AH cerradas localmente).
...
| S13/F4 artefactos versionados | conteo estricto: 68; retencion ampliada: 103; interseccion: 61. Los 25 `candidato_borrar` se reclasificaron a `archivar_condicionado`: 10 tienen cobertura estricta con refs externas y 15 exigen comprobacion por ruta sin inferir ausencia de refs. Persisten proyeccion comun de procedencia, smoke real aislado y migracion gobernada de movibles. Evidencia en la [incidencia S13](incidencias/incidencia_orquesta_s13_destino_recibos_runtime_2026-07-10.md) y la [incidencia 219](incidencias/incidencia_orquesta_s13_clasificacion_borrado_referenciada_2026-07-11.md). | abrir ola separada de comprobacion de referencias y destino trazable; no borrar ni mover en esta fase |
...
- BUG-ORQ-20260711-220: cerrado por `bc5a2cdcf`. `runtime_models` usa fichero
  canonico con secreto confinado, precedencia unica y validacion estricta de
  URL/timeout/enabled. Evidencia en la [incidencia 220](incidencias/incidencia_orquesta_runtime_models_secret_config_insegura_2026-07-11.md).
- BUG-ORQ-20260711-208AG: cerrado por `a245a90a8` + `7a91f8052` sobre la
  ...
  quedan cableados. U1000 se reproduce como check contractual y staticcheck
  vigente queda verde. Evidencia en la [incidencia 208AG](incidencias/incidencia_orquesta_cleanup_symbols_self_declared_2026-07-11.md).
- BUG-ORQ-20260711-208AH: cerrado por `514b86c49`. Preflight por mounts,
  presupuesto, caches privadas y cleanup confirmado dejan recibos durables; la
  reapertura equivalente real paso con 1 GiB de reserva. Evidencia en la
  [incidencia 208AH](incidencias/incidencia_orquesta_home_lleno_reapertura_subagente_2026-07-11.md).
