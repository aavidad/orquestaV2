...
| BUG-ORQ-20260710-208J | candidata `wip/attestation-208j-20260710` (`aeda02ee1`) persiste `failed` y rework tras error del atestador; no esta integrada ni revisada sobre principal | [incidencia 208J](incidencias/incidencia_orquesta_208h_claim_pending_sin_reintento_2026-07-10.md): rebasar 208H+208J, reejecutar focales y conservar cierre bloqueado hasta entonces |
