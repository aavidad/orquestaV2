...
| BUG-ORQ-20260710-208S | el corte local de `codex-wave-status` ya detecta presupuesto agotado, solicita parada cooperativa y persiste receipt/rework; no esta integrado aun en el supervisor residente ni replanifica sin polling | cablear la misma politica por puerto al ciclo goal-first/residente y probar escalada confirmada + replan causal; evidencia en la [incidencia 208S](incidencias/incidencia_orquesta_ola_codex_sin_progreso_diagnostico_excesivo_2026-07-10.md) |
