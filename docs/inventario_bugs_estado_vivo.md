...
| BUG-ORQ-20260711-208AE | goal-first `app_server_tmux` ignora el routing canonico: una tarea normal de codigo arranco con Sol/high, alcanzo 501059 tokens de thread y 42819 de goal sin diff | aplicar routing en la composicion goal-first, probar parametros de `turn/start` y repetir el smoke con Terra/medium; evidencia en la [incidencia 208AE](incidencias/incidencia_orquesta_goal_first_ignora_model_routing_2026-07-11.md) |
