...
| B10.1 | `60bf4646`: `AgentLaunchRequest` transporta autorización, aprobación, intento, cerca y tiempo durables; la liquidación defensiva conserva el enlace causal al intento. | Cerrada; no cambia el fingerprint histórico ni obliga al adaptador de proceso. | Delta real al regularizar |
