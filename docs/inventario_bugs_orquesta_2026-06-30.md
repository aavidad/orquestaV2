...
| BUG-ORQ-20260630-007 | abierto | Supervision HTTP | `/autoprogramming/supervise` despachaba agentes pero el cliente HTTP quedaba colgado | endpoints de control mezclan accion larga, streaming/ack y respuesta sin contrato temporal claro | incidencia OPES `TAREA_OPES_ORQUESTA_EXTERNAL_WORK_VALIDACION_Y_STREAM_2026-06-26.md` | Definir respuesta ack + observacion separada o timeout publico |
