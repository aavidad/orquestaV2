...
| BUG-ORQ-20260805-653 | abierto; mapa de cierre documentado | primer Codex físico en Firecracker | B10 lógico estaba cerca del cierre, pero no existía evidencia de un agente Codex real en microVM; el E2E histórico 1+16 solo acredita TestAttestor | faltan cuatro composiciones físicas: UDS root/no-root gobernado, egress por proxy preservado, credencial Codex sellada en tmpfs y broker host real; además los assets candidatos son anteriores al código actual | `docs/reconstruccion/auditoria_primer_codex_firecracker_2026-08-05.md` separa B10 offline de la acreditación física y fija minitareas/criterios; KVM y Firecracker están disponibles, sin confundirlo con sesión Codex | reconstruir assets actuales y cerrar las minitareas PFC-01..PFC-07 antes de afirmar primer Codex físico; sudo solo para instalar la frontera root y sus permisos auditables |
