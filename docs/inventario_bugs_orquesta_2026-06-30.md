...
- Avance 2026-07-04 noche: `BUG-ORQ-20260704-165` queda reducido tambien por
  ...
  persiste `goal_observer_timeout` como error accionable. Sigue abierto porque
  el corte depende de que el backend respete `context.Context` y falta
