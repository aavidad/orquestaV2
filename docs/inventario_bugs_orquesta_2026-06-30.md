...
operativa, no `/healthz`. El discovery completo de rutas sigue abierto en
`028`. H4 queda cerrado en codigo: el backend `app_server_tmux` limpia su sesion
propia si el arranque falla despues de crear tmux y antes de quedar operativo.
