...
| BUG-ORQ-20260805-632 | cerrado en código/offline por `3838dbe0`, `2b21911e` y `8e1d865d` | B10.3, capacidades/observación remotas | el adaptador podía operar contra una contraparte que no anunciase todas las operaciones necesarias o interpretar estado físico como trabajo | la negociación y la observación de sesión estaban incompletas y mezclaban autoridades | `TestAdapterRejectsIncompleteRemoteCapabilitiesBeforeLaunch` y `TestObserveAgentKeepsMissingAndAmbiguousSessionNonterminal` exigen capacidades completas y separan observación física/sesión | la composición canónica de B10.4 permanece abierta |
