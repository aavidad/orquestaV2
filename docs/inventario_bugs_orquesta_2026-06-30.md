...
- `BUG-ORQ-20260704-166` queda cerrado funcionalmente por `ff620ecf` para la
  causa observada: el escaneo de resultados saltaba caches voluminosas tarde y
  podia agotar el limite antes de encontrar el receipt terminal `complete`.
  Queda pendiente solo reintento de campo Sueldos/Orquesta.
