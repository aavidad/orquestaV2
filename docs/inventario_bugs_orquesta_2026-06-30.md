...
| --- | --- | --- | --- | --- | --- | --- |
| BUG-ORQ-20260723-354 | abierto | Council/P/S/E y presupuesto | V19 tenía producto integrado pero no un envelope V3/lifecycle inequívoco; el comando planned podía aparentar una prueba sin ejecutar los cuatro E2E, y los límites de tamaño anteriores no describían el árbol real | se mezclaban P, S y E en el fixture y se usaban techos aspiracionales como señal de simplicidad | P2 fija fixture schema 1/receipt V3, argv completo con guard/diff/suite/race/cuatro E2E/vet, candidate BASE..P2, y medición corregida 3441 (387 dominio, 1214 aplicación, 1835 SQLite, 0 bootstrap prod, 5 MCP/transporte; 3731 test; 53 ficheros candidatos >350); el primer conteo omitía 17 líneas de `claim.go` y el segundo no contaba el adaptador MCP | S debe sellar manifest/digest/mediciones; E debe emitir output+receipt V3 desde detached_clean y solo entonces promover roadmap/capabilities. V22 separa adaptadores grandes; P2 no declara PASS ni simplicidad verde |
