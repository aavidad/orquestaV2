...
| BUG-ORQ-20260630-032 | parcial | Tooling/agentes | varias instancias `codebase-memory-mcp` quedaron vivas al usar sesiones/subagentes y consumian CPU sin trabajo activo | la norma operativa obligaba a usar Codebase para navegacion de codigo y el bootstrap podia instalar/configurar el MCP como herramienta preferente, multiplicando procesos en trabajo paralelo | observacion local 2026-06-30: PIDs `809802`, `1232024`, `1232179`, `1232240`, `1232378` y `1375719` parados con `SIGTERM`; cambios en `AGENTS.md`, `~/.codex/AGENTS.md` y `scripts/bootstrap_agent_tooling.sh` | Cierre parcial: Codebase queda opt-in, prohibido por defecto en subagentes y sin instalacion/indexado por defecto en bootstrap. Pendiente: watchdog/lease de herramientas auxiliares para que Orquesta detecte MCPs/indexadores idle con CPU sostenida y los cierre o alerte |
