...
| BUG-ORQ-20260805-653 | abierto; PFC-02 cerrado en código/arnés | primer Codex físico en Firecracker | B10 lógico estaba cerca del cierre, pero no existía evidencia de un agente Codex real en microVM; el E2E histórico 1+16 solo acredita TestAttestor | faltan activos actuales, egress por proxy preservado, credencial Codex sellada, broker host real, instalación y E2E; la frontera UDS root/no-root ya quedó resuelta sin acreditar todavía el servicio físico | `docs/reconstruccion/auditoria_primer_codex_firecracker_2026-08-05.md` separa B10 offline de la acreditación física; `agente_microvm@989272d` cierra PFC-02 con GID efectivo, `SO_PEERCRED`, PID, permisos, publicación atómica, 354 pruebas y revisión xhigh | cerrar PFC-01 y PFC-03..PFC-07 antes de afirmar primer Codex físico; sudo solo para instalar la frontera root y sus permisos auditables |
