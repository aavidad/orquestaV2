...
```bash
go test ./orquestacionnucleoapp -run 'TestExternalProcessAgentLauncherV0' -count=1
```
...
```bash
go test ./orquestacionnucleoapp -run 'Test(AgentStopper|ProbeAgentReadiness|ExternalProcessAgentLauncherV0).*' -count=1
go test ./orquestacionnucleoapp -run 'TestRunOutboxDispatchBatch' -count=1
go test ./orquestacionnucleoapp -run 'TestRunProgressiveLoopV0UsesBatchDispatcherForTwoAgentLaunches' -count=1
go test ./orquestacionnucleoapp -run 'TestRunManagedProgressiveLoopV0' -count=1
go test ./orquestacionnucleoapp -run 'TestExternalProcessAgentBatchExecutorV0' -count=1
go test ./orquestacionnucleoapp -run 'TestWorkflowTaskCandidateProviderV0' -count=1
go test ./orquestacionnucleoapp -run 'TestProgressSupervisionCandidateProviderV0' -count=1
go test ./orquestacionnucleoapp -run 'TestDeliveryCandidateProviderV0' -count=1
go test ./orquestacionnucleoapp -run 'TestEvaluateAutoprogrammingReviewGateV0' -count=1
go test ./orquestacionnucleoapp -run 'TestProgressSupervisionLoopDetectedStopsAgentThroughOutbox' -count=1
go test ./orquestacionnucleoapp -run 'TestProgressiveLoopV0StopsAgentFromLeaseAssessment' -count=1
go test ./orquestacionnucleoapp -run 'TestProgressiveLoopV0ReplansFromStoppedAgentAssessment' -count=1
go test ./orquestacionnucleoapp -run 'TestComposedAgentLauncherDependenciesResolverV0|TestExternalAgentLaunchSpecResolverV0' -count=1
go test ./orquestacionnucleoapp -run 'Test(InMemoryAgentProcessRegistryV0|ProcessAgentStopperV0)' -count=1
go test ./orquestacionnucleoapp -run 'TestAgentLauncherExecutorV0WorkflowFailureStopsLaunchedProcess' -count=1
...
```bash
go test ./orquestacionnucleoapp -run 'TestBuildDirectorRunStatsV0ExponeCierre' -count=1
```
