...
de 159 fuentes con rol bug: 151 primarias y ocho fuentes task con rol adicional.
...
compactos como `...-211/212/213/214` y materializa 1.292 ocurrencias exactas —ref,
línea, columna y hash— en `historical_bug_occurrences.jsonl`.

Los 334 IDs normalizados quedan en `historical_bug_ids.jsonl`: 197 heredan la
unión exacta de sus filas ricas y 137 `narrative_only` usan una revisión
...
lección, no cierre del rebuild. De las 159 fuentes, 80 no declaran ningún ID
...
de IDs, después de revisar las 137 asignaciones narrativas, con
