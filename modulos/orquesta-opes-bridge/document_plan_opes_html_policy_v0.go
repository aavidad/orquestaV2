...
func opesHTMLPublicationPolicyV0() []string {
	return []string{
		...
		"paquete local de curso obligatorio: index.html, html_final por tema, assets locales, audio/manifests por tema y locales/i18n para controles visibles, siguiendo la forma de la web USO/TCAE promocion interna",
		...
		"material de estudio protegido: incluir la capa #uso-material-watermark con marca diagonal USO visible y coherente con la web TCAE/afiliados; no entregar HTML de curso sin fondo/marca de agua cuando proceda",
		"si el renderer de tema usa una plantilla interna, generate_html_site debe envolverla o adaptarla al formato final de curso USO; no entregar un visor single-file como salida final",
		"carcasa USO/TCAE obligatoria antes de marcar HTML publicable: header brand, course-switcher cuando proceda, indices de variante y sin navegacion legacy topnav en paginas de tema",
		"indices obligatorios cuando existan esas variantes: html_final/index.html, html_ampliado/index.html, html_resumido/index.html, bases/index.html y tests/index.html",
		"validar enlaces locales tras generar paginas auxiliares; href/src relativos rotos bloquean el cierre HTML",
		"no mostrar etiqueta publica 'Documentacion oficial'/'Documentación oficial' en tarjetas de tema; las fuentes oficiales deben vivir como contenido/cita editorial o metadata interna",
		...
		"controles, labels, mensajes, tests y feedback del HTML deben pasar por i18n/locales; no hardcodear textos de interfaz fuera del registro de idioma del paquete o de la web",
		"texto visible para alumnado no debe explicar como se ha generado el temario ni mostrar reutilizacion de comunes, refs, manifests, OPES, agentes, backend, staging, rutas o trazabilidad tecnica; moverlo a metadata/informes internos",
		...
		"colocacion de visuales: cada infografia debe quedar junto al apartado, tabla o parrafo que ayuda a estudiar; no acumular varias imagenes al principio del tema salvo mapa inicial deliberado",
...
func opesHTMLTopicTemplateV1() []string {
	return []string{
		...
		"body por defecto: class=\"first-reading-on\" y data-topic-key=\"temaNNN\"; primera lectura debe estar activa al abrir e incluir div#uso-material-watermark cuando el paquete sea material protegido",
