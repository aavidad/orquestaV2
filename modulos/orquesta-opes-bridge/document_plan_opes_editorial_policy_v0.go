...
func opesGlobalEditorialPolicyV0() []string {
	return []string{
		...
		"tests OPES: no modificar bancos originales sin orden expresa; crear salida nueva por banco/test_id, JSON por tema, HTML revisable por tema, index.html, metadata.json, informe Markdown y SQL local solo si procede; validar estructura, dificultad/proximidad y patrones prohibidos antes de dar listo",
