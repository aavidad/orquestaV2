...
func localHTMLSiteAcceptanceCriteriaV0() []string {
	return []string{
		...
		"aplicar carcasa USO/TCAE vigente antes de marcar HTML publicable: header brand, course-switcher cuando proceda, indices locales por variante y sin navegacion legacy topnav en paginas de tema",
		"generar y validar indices obligatorios de variante: html_final/index.html, html_ampliado/index.html, html_resumido/index.html, bases/index.html y tests/index.html cuando existan esas carpetas en el paquete",
		"validar enlaces locales despues de generar paginas auxiliares; bloquear si quedan href/src relativos rotos",
		"no mostrar etiqueta publica 'Documentacion oficial'/'Documentación oficial' en tarjetas de tema; las fuentes oficiales son contenido/cita editorial o metadata interna, no UI de carcasa",
...
func finalizedTemarioPackageAcceptanceCriteriaV0() []string {
	return append([]string{
		...
		"verificar carcasa USO/TCAE final: sin topnav legacy, con brand/course-switcher si aplica, indices de variantes presentes, links locales validos y sin etiquetas publicas antiguas de revision local",
