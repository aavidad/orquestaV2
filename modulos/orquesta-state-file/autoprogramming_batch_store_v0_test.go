...
func persistAutoprogrammingBatchThroughClaimV0(t *testing.T, store *StoreV0) orquestaautoprogramming.AutoprogrammingBatchV0 {
	...
	batch = persistAutoprogrammingBatchTransitionV0(t, store, batch, orquestaautoprogramming.ClaimAutoprogrammingBatchIntegrationV0(batch, batch.StoreVersion, "claim-integration-a", "integration-claim-a", "task-a", batch.BaseRevision))
	...
	batch = persistAutoprogrammingBatchTransitionV0(t, store, batch, orquestaautoprogramming.ClaimAutoprogrammingBatchIntegrationV0(batch, batch.StoreVersion, "claim-integration-b", "integration-claim-b", "task-b", "revision-a"))
