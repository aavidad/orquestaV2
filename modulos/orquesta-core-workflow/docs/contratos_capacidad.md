...
Invariantes:
  - Handler puro: no ejecuta nada ni decide cuenta, proveedor, modelo o runtime.
  - `phase_id` pertenece al catalogo v0.
  - `phase_id` debe coincidir con `run.current_phase` salvo no-op idempotente ya reflejado.
  - Payload compacto, sin DB, HOME, OAuth, Codex, Claude, Ollama, vLLM ni adaptadores.
...
Invariantes:
  ...
  - No contiene decision de proveedor/modelo, runtime, HOME ni adaptador.
Errores:
  - evento_invalido
  - payload_invalido
  - detalle_prohibido
...
Invariantes:
  ...
  - Payload compacto, sin DB, HOME, OAuth, Codex, Claude, Ollama, vLLM, provider/model/runtime ni adaptadores.
Errores:
  - payload_invalido
  - detalle_prohibido
  - transicion_invalida
...
Invariantes:
  ...
  - No contiene proveedor/modelo concreto, runtime, HOME, OAuth, cuenta, cuota real ni adaptador.
Errores:
  - evento_invalido
  - payload_invalido
  - detalle_prohibido
...
Invariantes:
  ...
  - No incluye proveedor, modelo, cuenta, HOME, runtime ni adaptador.
