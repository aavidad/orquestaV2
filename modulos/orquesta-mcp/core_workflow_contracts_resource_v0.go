...
func coreWorkflowCommandGuidesMCPV0() []MCPCoreWorkflowTransitionGuideV0 {
	return []MCPCoreWorkflowTransitionGuideV0{
		...
		coreWorkflowTransitionMCPV0(orquestacoreworkflow.OrchestrationCommandResolveRunBlockerV0, "command", "", []string{"blocker_id", "resolution_ref"}, []string{"blockers", "status=activa"}),
...
func coreWorkflowEventGuidesMCPV0() []MCPCoreWorkflowTransitionGuideV0 {
	return []MCPCoreWorkflowTransitionGuideV0{
		...
		coreWorkflowTransitionMCPV0(orquestacoreworkflow.OrchestrationEventRunBlockerResolvedV0, "event", "", []string{"blocker_id", "resolution_ref"}, []string{"blockers", "status=activa"}),
