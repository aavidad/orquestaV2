...
func MCPTransportToolsV0(bindings MCPTransportBindingsV0) []MCPTransportToolEnvelopeV0 {
	...
	tools := []MCPTransportToolEnvelopeV0{
		...
		mcpTransportToolEnvelopeV0(descriptors.council.Name, descriptors.council.Version, descriptors.council.ResourceURI, descriptors.council.InputSchema, descriptors.council.Output, mcpCouncilTransportHandlerV0(bindings.Council)),
		mcpTransportToolEnvelopeV0(descriptors.autonomyProgram.Name, descriptors.autonomyProgram.Version, descriptors.autonomyProgram.ResourceURI, descriptors.autonomyProgram.InputSchema, descriptors.autonomyProgram.Output, mcpAutonomyProgramTransportHandlerV0(bindings.AutonomyProgram)),
...
func applyMCPTransportExecutionProfilesV0(
	...
	for idx := range tools {
		...
		case MCPWorkspaceTimelineToolNameV0,
			...
			MCPCouncilToolNameV0,
			MCPAutonomyProgramToolNameV0,
