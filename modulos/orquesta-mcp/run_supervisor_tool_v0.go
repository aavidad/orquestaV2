...
func MCPRunSupervisorDescriptorV0() MCPRunSupervisorToolDescriptorV0 {
	return MCPRunSupervisorToolDescriptorV0{
		...
		Output:      "ok:{run_ref,stop_reason,ticks,last,history?,evidence_refs?,idempotency_key?,operation_ref?,repair_run_refs?,diagnostics?[]{code,scope?,message?,evidence_refs?},next_actions?}|error:{errores_publicos,evidence_refs?,idempotency_key?,operation_ref?,repair_run_refs?,diagnostics?[]{code,scope?,message?,evidence_refs?},next_actions?}",
