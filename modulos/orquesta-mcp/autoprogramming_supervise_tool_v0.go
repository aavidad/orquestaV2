...
func MCPAutoprogrammingSuperviseDescriptorV0() MCPAutoprogrammingSuperviseToolDescriptorV0 {
	return MCPAutoprogrammingSuperviseToolDescriptorV0{
		...
		Output:      "ok:{run_ref,stop_reason,ticks,last,history?,evidence_refs?,operation_ref?,operator_advice?,diagnostics?}|error:{errores_publicos,evidence_refs?,operation_ref?,operator_advice?,diagnostics?}",
