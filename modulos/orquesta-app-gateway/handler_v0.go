...
func NewRouteHandlersV0(config ConfigV0) orquestahttpgateway.RouteHandlersV0 {
	...
	return orquestahttpgateway.RouteHandlersV0{
		...
		AutoprogrammingPage:               orquestaweb.NewAutoprogrammingWebEndpointV0(newAutoprogrammingStatusClientV0(config, client)),
		...
		AppIntakeWizardBot:                apiHandlers.AppIntakeWizardBot,
...
func NewAPIRouteHandlersV0(config ConfigV0) orquestahttpgateway.RouteHandlersV0 {
	...
	return orquestahttpgateway.RouteHandlersV0{
		...
		AppIntakeWizardBot:                orquestaweb.NewNuevaAppWizardBotHTTPHandlerWithAssistantV0(config.WizardBotAssistant),
