...
func buildStackHTTPHandlerV0(
	...
	handler := orquestaappgateway.NewHTTPHandlerV0(orquestaappgateway.ConfigV0{
		...
		WizardBotAssistant:                config.WizardBotAssistant,
...
func buildDirectorPortsV0(
	...
	return orquestaappdirectorservice.StartAppDirectorPortsV0{
		...
		GoalLauncher: goalLauncherWithCodeContextPrepareFromConfigV0(
			goalLauncherWithRequiredTestsDependenciesFromConfigV0(config.AppGoalLauncher, config.GoalRequiredTestDependencies),
			config.CodeContext,
		),
		GoalReworkLauncher: goalLauncherWithCodeContextPrepareFromConfigV0(
