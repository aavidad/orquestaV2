...
func directorDecisionInstructionsV0(
	...
	return []string{
		...
		"Primera entrega accionable del director: open_phase(votacion_y_decision), request_vote con BrainstormRef inicial, accept_decision, open_phase(planificacion_microtareas), publish_function_contract, create_microtask(s) de phase_id programacion y open_phase(programacion).",
		...
		"Fases: en open_phase, decision.phase_id es la fase actual y open_phase.phase_id la fase a abrir; en los demas comandos con phase_id, decision.phase_id debe ser igual al phase_id del payload.",
