	...
	return []appChangeOPESSubroleV0{
		{
			...
			Criteria:     "Entregar matriz de fuentes oficiales, vigencia, huecos y evidencia compacta del tema; empezar por curso/tema/programa/canon y excluir backups, paquetes historicos y runtime salvo auditoria global explicita.",
		...
		},
		{
			...
			Criteria:     "Entregar decision de reutilizacion, adaptacion o rework sin rehacer material valido; acotar busqueda a curso/tema/canon y excluir backups, paquetes historicos y runtime salvo auditoria global explicita.",
