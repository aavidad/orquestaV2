...
func geminiGoalPromptWithRuntimeReceiptV0(prompt string, runtimeDir string, goalRef string, locale string) string {
	path := geminiGoalRuntimeResultPathV0(runtimeDir, goalRef)
	if geminiGoalPromptEnglishLocaleV0(locale) {
