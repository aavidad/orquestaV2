...
const (
	HTTPTransportProfileOPESTemporalV0 = "opes_temporal"
...
func DefaultHTTPTransportPolicyV0() HTTPTransportPolicyV0 {
	return HTTPTransportPolicyV0{
		Profile:               HTTPTransportProfileOPESTemporalV0,
...
func newOPESHTTPClientV0(timeout time.Duration) *http.Client {
	return &http.Client{
		Timeout:   timeout,
		Transport: newOPESHTTPTransportV0(DefaultHTTPTransportPolicyV0()),
	}
}

func newOPESHTTPTransportV0(policy HTTPTransportPolicyV0) *http.Transport {
