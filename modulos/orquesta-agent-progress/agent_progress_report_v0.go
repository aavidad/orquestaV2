...
func (v *agentProgressReportValidatorV0) requireOpaque(field, value string) {
	...
	switch {
	case agentProgressLooksLikeSecretV0(value):
	...
	case !agentProgressOpaqueRefPatternV0.MatchString(value):
...
func (v *agentProgressReportValidatorV0) requireSummary(field, value string) {
	...
	switch {
	case agentProgressLooksLikeSecretV0(trimmed):
		v.add(AgentProgressSecretoDetectadoV0, field)
...
var agentProgressOpaqueRefPatternV0 = regexp.MustCompile(`^[A-Za-z0-9][A-Za-z0-9._:-]{2,511}$`)
