...
const (
	CliHTTPTransportProfileLoopbackControlPlaneV0 = "loopback_control_plane"
	CliHTTPProxyPolicyDenyV0                      = "deny"
)

type CliHTTPTransportPolicyV0 struct {
	Profile               string
	ProxyPolicy           string
...
func DefaultCliHTTPTransportPolicyV0() CliHTTPTransportPolicyV0 {
	return CliHTTPTransportPolicyV0{
		Profile:               CliHTTPTransportProfileLoopbackControlPlaneV0,
		ProxyPolicy:           CliHTTPProxyPolicyDenyV0,
...
func newCLILoopbackHTTPClientV0(timeout time.Duration) *http.Client {
	return &http.Client{
		Timeout:   timeout,
		Transport: newCLIHTTPTransportV0(DefaultCliHTTPTransportPolicyV0()),
	}
}

func newCLIHTTPTransportV0(policy CliHTTPTransportPolicyV0) *http.Transport {
