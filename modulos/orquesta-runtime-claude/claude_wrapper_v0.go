...
func BuildClaudeGoalWrapperScriptV0(
	...
	b.WriteString(command)
	b.WriteString(" < ")
	b.WriteString(claudeShellQuoteV0(promptPath))
	b.WriteString(" > ")
	b.WriteString(claudeShellQuoteV0(stdoutPath))
	b.WriteString(" 2> ")
	b.WriteString(claudeShellQuoteV0(stderrPath))
	b.WriteString(" &\n")
	b.WriteString("orquesta_claude_goal_child_v0=$!\n")
	b.WriteString("trap 'kill \"$orquesta_claude_goal_child_v0\" 2>/dev/null; ")
	b.WriteString("wait \"$orquesta_claude_goal_child_v0\" 2>/dev/null; exit 143' INT TERM\n")
	b.WriteString("wait \"$orquesta_claude_goal_child_v0\"\n")
	b.WriteString("orquesta_claude_goal_status_v0=$?\n")
	b.WriteString("trap - INT TERM\n")
	b.WriteString("set -e\n")
	b.WriteString("exit \"$orquesta_claude_goal_status_v0\"\n")
	return b.String()
}
