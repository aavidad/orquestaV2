...
func codexSharedStartupLockShellV0(defaultSeconds string) string {
	...
	return strings.Join([]string{
		...
		"  orquesta_codex_lock_timeout_for_stale_v0=\"${orquesta_codex_lock_timeout_v0:-120}\"",
		"  case \"$orquesta_codex_lock_timeout_for_stale_v0\" in ''|*[!0-9]*) orquesta_codex_lock_timeout_for_stale_v0=120;; esac",
		"  orquesta_codex_lock_stale_seconds_v0=\"${ORQUESTA_CODEX_STARTUP_LOCK_STALE_SECONDS:-$orquesta_codex_lock_timeout_for_stale_v0}\"",
		"  case \"$orquesta_codex_lock_stale_seconds_v0\" in ''|*[!0-9]*) orquesta_codex_lock_stale_seconds_v0=\"$orquesta_codex_lock_timeout_for_stale_v0\";; esac",
		"  if [ \"$orquesta_codex_lock_stale_seconds_v0\" -gt \"$orquesta_codex_lock_timeout_for_stale_v0\" ]; then orquesta_codex_lock_stale_seconds_v0=\"$orquesta_codex_lock_timeout_for_stale_v0\"; fi",
		...
		"orquesta_codex_lock_explicit_v0=\"\"",
		"if [ \"${ORQUESTA_CODEX_STARTUP_LOCK_SECONDS+x}\" = \"x\" ]; then orquesta_codex_lock_explicit_v0=\"1\"; fi",
		"if [ \"${ORQUESTA_CODEX_STARTUP_LOCK_TIMEOUT_SECONDS+x}\" = \"x\" ]; then orquesta_codex_lock_explicit_v0=\"1\"; fi",
		"if [ \"${ORQUESTA_CODEX_STARTUP_LOCK_STALE_SECONDS+x}\" = \"x\" ]; then orquesta_codex_lock_explicit_v0=\"1\"; fi",
