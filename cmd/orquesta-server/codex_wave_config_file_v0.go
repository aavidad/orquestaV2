...
func codexWaveEffectiveConfigSettingsV0(
	...
	return []orquestaserver.ServerConfigSettingV0{
		...
		serverConfigSettingFromRegistryWithSourceV0(envCodexWaveModelV0, codexWaveStringValueFromProjectConfigFileV0(projectConfig, envCodexWaveModelV0, firstNonEmptyEnvV0(envCodexModelV0)), configSettingSourceFromConfigOrProjectConfigV0(config, envCodexWaveModelV0)),
		...
		serverConfigSettingFromRegistryWithSourceV0(envCodexWaveProfileV0, codexWaveStringValueFromProjectConfigFileV0(projectConfig, envCodexWaveProfileV0, firstNonEmptyEnvV0(envCodexProfileV0)), configSettingSourceFromConfigOrProjectConfigV0(config, envCodexWaveProfileV0)),
