...
func writeBacklogPlannerCorrelatedACKForTestV0(
	...
	packet := fmt.Sprintf(`{"schema_version":"agent_start_packet.v0","request_id":"agent-ref-t08","correlation_id":"corr-%s-burst-001","target_module":"orquesta-app-stack-programacion","task":{"task_ref":"task-t08","required_tests":%s},"delivery_refs":{"ack_ref":"ack-ref-t08"}}`, normalizedRunRef, mustJSONArrayForBacklogAckTestV0(t, requiredTests))
