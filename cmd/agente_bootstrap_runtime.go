...
type agenteBootstrapRuntimeState struct {
...
func prepararBootstrapRuntimeAgente(agente string, proyecto *db.Proyecto, ultima *db.Sesion) (runtimeagente.ResumeContext, *agenteBootstrapRuntimeState, error) {
	...
	// Materializa órdenes básicas como nudge -> mailbox antes de recoger el bootstrap.
	if _, err := db.ProcesarRuntimeOrdersBatch(); err != nil {
		return resume, nil, err
	}

	state := &agenteBootstrapRuntimeState{}
...
func ajustarResumeDesdeBootstrap(resume *runtimeagente.ResumeContext, proyecto *db.Proyecto, state *agenteBootstrapRuntimeState) {
...
func construirResumePayloadBootstrap(prev string, state *agenteBootstrapRuntimeState) string {
...
func construirResumenBootstrap(prev string, state *agenteBootstrapRuntimeState) string {
