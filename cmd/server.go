...
var serverRunCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		server := &http.Server{
			Addr:    listenAddr,
			Handler: localrpc.NewMux(&localrpc.Server{State: info, Executor: executeRPCRequest}),
		}
...
func executeRPCRequest(ctx context.Context, req *localrpc.ExecRequest) (*localrpc.ExecResponse, error) {
